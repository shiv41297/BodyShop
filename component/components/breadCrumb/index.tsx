                ...
                {skeletonLoader ?
                    ...
                    : breadcrumb.map((val: any, i: any) => (
                        <>
                            ...
                            <div className={i === breadcrumb.length - 1 ? classes.breadCurrent : classes.bread} onClick={() => {
                                if (state)
                                    history.push({ pathname: val.action, state })
                                else
                                    history.push(val.action)

                            }} key={i} style={{ color: type === "white" ? "var(--white)" : "var(--primary)" }}>
                                {
                                    i !== 0 ?
                                        "/ " : ""
                                }
