...
instance.interceptors.request.use(
  ...
  // success.headers.Authorization = `Bearer ${getAuthToken()}`;
  success.headers.Authorization = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiI2MzQ1MGNkYmQ3ZWQ5ODY5NzFlYjIxNDQiLCJpc0xvZ2luIjp0cnVlLCJpc0d1ZXN0TG9naW4iOnRydWUsImlhdCI6MTY2NTQ2OTY1OSwiZXhwIjoxNjgxMDIxNjU5fQ.iCL5BHGnsqw6HuCa2AZUBH6HNSLuaAETCQjM-MBkIxw"
